...
public class ExceptionHandlingController implements ErrorController {
    ...
    // 에러 페이지 정의
    private final String ERROR_404_PAGE_PATH = "/error/404"; // 경로 문제
    private final String ERROR_500_PAGE_PATH = "/error/500"; // 서버 문제
    private final String ERROR_ETC_PAGE_PATH = "/error/error"; //기타 문제
