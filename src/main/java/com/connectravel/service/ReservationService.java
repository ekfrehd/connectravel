...
public interface ReservationService {
    ReservationDTO bookRoom(ReservationDTO reservationDTO); // 예약 생성
    ReservationDTO getRoomBookingDetails(Long rvno); // 예약 조회
    ReservationDTO modifyRoomBooking(Long rvno, ReservationDTO reservationDTO); // 예약 수정
    boolean requestCancel(Long rvno, String userEmail); // 예약 취소 요청
    boolean approveCancellation(Long rvno); // 예약 취소 승인
