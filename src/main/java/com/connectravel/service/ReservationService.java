...
public interface ReservationService {
    ...
    /* 예약 목록 조회 */
    List<ReservationDTO> listUserRoomBookings(String userEmail); // 사용자별
    List<ReservationDTO> listAccommodationRoomBookings(Long ano);// 숙소별
    List<ReservationDTO> listRoomBookings(Long rno);// 방별
