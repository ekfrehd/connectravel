...
public class QnaBoardServiceImpl implements QnaBoardService {
    ...
    public Long register(QnaBoardDTO dto) {
        ...
        QnaBoardEntity qnaBoard = dtoToEntity(dto, memberRepository);
...
*/
    ...
    public QnaBoardDTO get(Long bno) {
        ...
        return entityToDTO((QnaBoardEntity) arr[0], (Member)arr[1]);
    }

    @Transactional
    @Override
    public void modify(QnaBoardDTO qnaBoardDTO) {
        QnaBoardEntity qnaBoard = qnaBoardRepository.getOne(qnaBoardDTO.getBno()); //boardRepository에서 Board객체를 받아
