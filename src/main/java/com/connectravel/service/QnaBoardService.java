...
public interface QnaBoardService {
    ...
    default QnaBoardDTO entityToDTO (QnaBoard qnaBoard, Member member) {
        ...
        QnaBoardDTO qnaBoardDTO = QnaBoardDTO.builder ().bno (qnaBoard.getBno ()).title (qnaBoard.getTitle ()).content (qnaBoard.getContent ()).regDate (qnaBoard.getRegTime ()).modDate (qnaBoard.getModTime ()).createdBy (qnaBoard.getCreatedBy ()).modifiedBy (qnaBoard.getModifiedBy ()).build ();
